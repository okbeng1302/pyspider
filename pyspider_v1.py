...
class Handler(BaseHandler):
                ...
                for dd in filter_attr2_dds:
                    ...
                    if f_c_href.find('html?') != -1:
                        ...
                        if f_c_href.find(';') != -1:
                            ...
                            self.crawl(url,callback=self.parse_course1,save={'category_name':category_name,'filter_attr1':filter_attr1,'filter_attr2':filter_attr2})                            
                        # 中学
                        elif f_c_href.find('MiddleSchool') != -1:
                            req_url = f_c_href + '&applystate=0&hide=0'
                            self.crawl(req_url,callback=self.parse_course2,save={'category_name':category_name,'filter_attr1':filter_attr1,'filter_attr2':filter_attr2})
                        # 课程
                        elif f_c_href.find(r'Course') != -1:
                           # print f_c_href
                            self.crawl(f_c_href,fetch_type='js',callback=self.parse_course3,save={'category_name':category_name,'filter_attr1':filter_attr1,'filter_attr2':filter_attr2,'PageNumber':1})
                        # 四个参数  
                        else:
                            # print f_c_href
                            pattern = (r'Category\/(.*?)-(.*?)-(.*?)-(.*?)\.html?')
                            ...
                            if len(url_params) == 0:
                               ...
                               # print url_params
                                ...
                                # print f_c_href
                                self.crawl(f_c_href,callback=self.parse_course4,save={'category_name':category_name,'filter_attr1':filter_attr1,'filter_attr2':filter_attr2})
                                # print f_c_href
                    else:
                        #print f_c_href
                        if 'publish' in f_c_href:
                            ...
                            if 'Course' in f_c_href:
                                ...
                                self.crawl(f_c_href,fetch_type='js',callback=self.parse_course5,save={'category_name':category_name,'filter_attr1':filter_attr1,'filter_attr2':filter_attr2,'PageNumber':1,'Coursecode':Coursecode})
                            else:
                                # print f_c_href
                                if 'kw' in f_c_href:
                                    f_c_href = f_c_href + '&applystate=0&hide=0'
                                    # print f_c_href
                                    self.crawl(f_c_href,callback=self.parse_course6,save={'category_name':category_name,'filter_attr1':filter_attr1,'filter_attr2':filter_attr2})
                                else:
                                    if 'bjuu' in f_c_href:
                                        pass
                                    else:
                                        if f_c_href.find('hide') == -1:
                                            f_c_href = f_c_href + '&applystate=0&hide=0'
                                        self.crawl(f_c_href,callback=self.parse_course1,save={'category_name':category_name,'filter_attr1':filter_attr1,'filter_attr2':filter_attr2})  
    ...
    def parse_course6(self,response):
        ...
        if next_page == '':
            ...
            self.crawl(next_page,callback = self.parse_course6,save={'category_name':response.save['category_name'],'filter_attr1':response.save['filter_attr1'],'filter_attr2':response.save['filter_attr2']})
    def parse_course6_detail(self,response):
        ...
        if next_page == None:
            ...
            print base_next_url
            self.crawl(base_next_url,fetch_type='js',callback=self.parse_course6_detail,save={'category_name':category_name,'PageNumber':PageNumber+1,'city_name':city_name,'cid':cid,'Coursecode':Coursecode,'filter_attr1':filter_attr1,'filter_attr2':filter_attr2,'course_name':course_name,'keyword':keyword})
    ...
    def parse_course5(self,response):
        ...
        if next_page == None:
            ...
            print base_next_url
            self.crawl(base_next_url,fetch_type='js',callback=self.parse_course5,save={'PageNumber':PageNumber+1,'city_name':city_name,'cid':cid,'category_name':response.save['category_name'],'Coursecode':Coursecode,'filter_attr1':filter_attr1,'filter_attr2':filter_attr2,'course_name':course_name})
    ...
    def parse_course1(self,response):
        ...
        if next_page == '':
            ...
            self.crawl(next_page,callback = self.parse_course1,save={'category_name':response.save['category_name'],'filter_attr1':response.save['filter_attr1'],'filter_attr2':response.save['filter_attr2']})
    ...
    def parse_course2(self,response):
        ...
        for div in course_divs:
            ...
            print course_code
            self.crawl(course_href,fetch_type='js',callback=self.parse_course2_detail,save={'category_name':response.save['category_name'],'filter_attr1':response.save['filter_attr1'],'filter_attr2':response.save['filter_attr2'],'course_name':course_name,'course_code':course_code,'PageNumber':1})
            next_page = response.doc('.m-page > div > a.nextlink').attr.href
            print "下一页",next_page
            if next_page == None:
                next_page = ''
            ...
            if next_page == '':
                ...
                self.crawl(next_page,callback = self.parse_course2,save={'category_name':response.save['category_name'],'filter_attr1':response.save['filter_attr1'],'filter_attr2':response.save['filter_attr2']})
    @config(priority=10)       
    def parse_course2_detail(self,response):
        ...
        if next_page == None:
            ...
            print next_page_url
            self.crawl(next_page_url,callback=self.parse_course2_detail,save={'category_name':response.save['category_name'],'course_code':class_id_v,'filter_attr1':response.save['filter_attr1'],'filter_attr2':response.save['filter_attr2'],'Coursecode':Coursecode,'course_name':course_name,'PageNumber':PageNumber+1,'city_name':city_name})
    ...
    def parse_course3(self,response):
        ...
        if next_page == None:
            ...
            print base_next_url
            self.crawl(base_next_url,fetch_type='js',callback=self.parse_course3,save={'PageNumber':PageNumber+1,'keyword':keyword,'city_name':city_name,'cid':cid,'Coursecode':Coursecode,'category_name':response.save['category_name'],'filter_attr1':filter_attr1,'filter_attr2':filter_attr2,'course_name':course_name})
    ...
    def parse_course4(self,response):
        ...
        for div in course_div:
            ...
            course_href = div('div[class="m-courselist-l pr"] > h2 > a').attr.href
            print '课程链接',course_href
            self.crawl(course_href,callback=self.parse_course4_detail,save={'category_name':response.save['category_name'],'filter_attr1':response.save['filter_attr1'],'filter_attr2':response.save['filter_attr2'],'course_name':course_name,'course_code':course_code,'PageNumber':1})
        ...
        if next_page == '':
            ...
            self.crawl(next_page,callback = self.parse_course4,save={'category_name':response.save['category_name'],'filter_attr1':response.save['filter_attr1'],'filter_attr2':response.save['filter_attr2']})
    ...
    def parse_course4_detail(self,response):
        ...
        if next_page == None:
            ...
            print next_page_url
            self.crawl(next_page_url,callback=self.parse_course4_detail,save={'city_name':city_name,'cid':cid,'category_name':response.save['category_name'],'filter_attr1':filter_attr1,'filter_attr2':filter_attr2,'course_name':course_name,'course_code':course_id,'PageNumber':PageNumber+1})
    ...
    def parse_course1_detail(self,response):
        ...
        if next_page == None:
            ...
            self.crawl(req_url,callback=self.parse_course1_detail,save={'city_name':city_name,'cid':cid,'category_name':response.save['category_name'],'filter_attr1':filter_attr1,'filter_attr2':filter_attr2,'course_name':course_name,'course_code':CourseCode,'PageNumber':PageNumber+1})
    ...
    def on_result(self,result):
        ...
        if web_xdf_courses.find_one({'course_id':result['course_id'],'update_time':result['update_time']}):
            print '此课程已存在'
        else:
